...
sed -i 's#https://github.com/pi-hole/pi-hole#https://github.com/hassio-addons/addon-pi-hole#g' "${base}/scripts/pi-hole/php/header.php"
sed -i 's#https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3J2L3Z4DHW9UY#https://www.paypal.me/FranckNijhof#g' "${base}/scripts/pi-hole/php/header.php"
sed -i 's#https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=3J2L3Z4DHW9UY#https://www.paypal.me/FranckNijhof#g' "${base}/scripts/pi-hole/php/header.php"
sed -i 's#https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=3J2L3Z4DHW9UY#https://www.paypal.me/FranckNijhof#g' "${base}/scripts/pi-hole/php/footer.php"
